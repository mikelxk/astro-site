...
<img src="/assets/bench.webp" alt="benchmark" width="800" style="border-radius:10px"/>
...
## Sources
You can find the link to the blog source code [here](https://github.com/mikelxk/astro-site)
